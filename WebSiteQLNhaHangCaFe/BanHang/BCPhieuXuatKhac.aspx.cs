...
namespace BanHang
{
    public partial class BCPhieuXuatKhac : System.Web.UI.Page
    {
        ...
        protected void btnXemBaoCao_Click(object sender, EventArgs e)
        {
            ...
            dtLichSuTruyCap.ThemLichSu(Session["IDChiNhanh"].ToString(), Session["IDNhom"].ToString(), Session["IDNhanVien"].ToString(), "Báo cáo xuất khác", "Xem báo cáo xuất khác");

            popup.ContentUrl = "~/BCPhieuXuatKhac_In.aspx?ngayBD=" + ngayBD + "&ngayKT=" + ngayKT;

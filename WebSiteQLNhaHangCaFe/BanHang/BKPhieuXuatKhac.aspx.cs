...
namespace BanHang
{
    public partial class BKPhieuXuatKhac : System.Web.UI.Page
    {
        ...
        protected void btnXem_Click(object sender, EventArgs e)
        {
            ...
            dtLichSuTruyCap.ThemLichSu(Session["IDChiNhanh"].ToString(), Session["IDNhom"].ToString(), Session["IDNhanVien"].ToString(), "Bảng kê xuất khác", "Xem bảng kê xuất khác");

            popup.ContentUrl = "~/BKPhieuXuatKhac_In.aspx?ngayBD=" + ngayBD + "&ngayKT=" + ngayKT;

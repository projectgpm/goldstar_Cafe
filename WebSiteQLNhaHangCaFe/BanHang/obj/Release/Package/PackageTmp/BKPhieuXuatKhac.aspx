<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="BKPhieuXuatKhac.aspx.cs" Inherits="BanHang.BKPhieuXuatKhac" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    
    <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Width="100%">
        <Items>
            <dx:LayoutGroup Caption="Bảng kê phiếu xuất khác" ColCount="4" HorizontalAlign="Center">
                <Items>
                    ...
                    <dx:LayoutItem Caption="">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer8" runat="server">
                                <dx:ASPxButton ID="btnXem" runat="server" Text="Xem bảng kê" Width="100%" OnClick="btnXem_Click">
